...
import 'package:mybudget/features/jars/presentation/screens/jars_tab.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  List<PersistentTabConfig> _tabs() => [
    ...
    PersistentTabConfig(
      ...
      item: ItemConfig(
        icon: const Icon(Icons.add, size: 30), // Biểu tượng "+" lớn hơn
        // title: "",
        activeForegroundColor: Colors.blue,
        inactiveForegroundColor: Colors.grey,
      ),
